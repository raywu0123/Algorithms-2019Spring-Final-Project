...
//{{{
{
  ...
  if (flag)
  {
      if (x1() > box->x2()) return false;
      if (y1() > box->y2()) return false;
      if (x2() < box->x1()) return false;
      if (y2() < box->y1()) return false;
      if (x1()==box->x2() && y1()==box->y2()) return false;
      if (x2()==box->x1() && y2()==box->y1()) return false;
      if (x1()==box->x2() && y2()==box->y1()) return false;
      if (x2()==box->x1() && y1()==box->y2()) return false;
      return true;
...
//{{{
{
    ...
    */
    ...
    if (x1() < box->x1()) {
        bBox* B = new bBox(x1(), (y1() > box->y1())?y1():box->y1(), box->x1(), (y2() < box->y2())?y2():box->y2());
        ret.push_back(B); // B
        // std::cout << "(" << B->x1() << "," << B->y1() << ") "
        //           << "(" << B->x2() << "," << B->y2() << ") " << std::endl;
    }
    if (x2() > box->x2()) {
        bBox* C = new bBox(box->x2(), (y1() > box->y1())?y1():box->y1(), x2(), (y2() < box->y2())?y2():box->y2());
        ret.push_back(C); // C
        // std::cout << "(" << C->x1() << "," << C->y1() << ") "
        //           << "(" << C->x2() << "," << C->y2() << ") " << std::endl;
    }
